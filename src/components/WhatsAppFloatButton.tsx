  ...
  return (
    <div className="fixed bottom-6 right-6 z-45" id="whatsapp-float-container">
      <a
        ...
        className="flex items-center justify-center w-14 h-14 bg-[#25D366] hover:bg-[#22c35e] active:scale-95 text-white rounded-full shadow-lg hover:shadow-xl transition-all duration-300 animate-pulse-green relative group"
      >
        {/* SVG/Lucide Icon */}
